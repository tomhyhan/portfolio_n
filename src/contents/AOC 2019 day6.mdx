---
title: The Adcent of Rust - AOC 2019 day 6"
slug: "advent-of-code-2019-day-6"
...
```
<note>
    this is a sample input, the actual input is much larger
</note>
...
```
<note>
    dfs function does not take self as a parameter to simplify the code. Otherwise, rust's borrow checker will complain about multiple mutable borrows.
</note>
...
```
<information>
    we can further optimize by refactoring the code by spilting our min_traverse_distance() function. it will give us better readability and testability.
</information>
